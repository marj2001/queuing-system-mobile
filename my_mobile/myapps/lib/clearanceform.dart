...
class ClearanceForm extends StatefulWidget {
  ...
  @override
  ClearanceFormState createState() => ClearanceFormState();
}

class ClearanceFormState extends State<ClearanceForm> {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      final url = Uri.parse('http://192.168.1.11/mybackend/submit_clearance.php');
